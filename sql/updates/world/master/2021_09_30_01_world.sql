...
INSERT INTO `quest_poi` (`QuestID`, `BlobIndex`, `Idx1`, `ObjectiveIndex`, `QuestObjectiveID`, `QuestObjectID`, `MapID`, `WorldMapAreaId`, `Floor`, `Priority`, `Flags`, `WorldEffectID`, `PlayerConditionID`, `NavigationPlayerConditionID`, `SpawnTrackingID`, `AlwaysAllowMergingBlobs`, `VerifiedBuild`) VALUES
(8326, 0, 2, 32, 0, 0, 530, 893, 0, 0, 0, 0, 0, 0, 120146, 0, 40120),
(8326, 0, 1, 0, 256445, 20797, 530, 893, 0, 0, 1, 0, 0, 0, 0, 0, 40120),
(8326, 0, 0, -1, 0, 0, 530, 893, 0, 0, 1, 0, 0, 0, 0, 0, 40120);

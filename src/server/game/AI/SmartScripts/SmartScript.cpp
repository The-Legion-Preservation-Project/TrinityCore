                ...
                if (IsUnit(target))
                {
                    switch (e.action.setunitByte.type)
                    {
                        ...
                        case 3:
                            ...
                            target->ToUnit()->SetAnimTier(UnitBytes1_Flags(target->ToUnit()->GetByteValue(UNIT_FIELD_BYTES_1, UNIT_BYTES_1_OFFSET_ANIM_TIER) | e.action.setunitByte.byte1), false);
                            break;
                    }
                }
            break;

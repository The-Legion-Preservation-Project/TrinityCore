...
enum NPCFlags : uint64
{
    ...
    UNIT_NPC_FLAG_TRAINER_CLASS             = 0x00000000020,     // TITLE is class trainer DESCRIPTION 100%
    UNIT_NPC_FLAG_TRAINER_PROFESSION        = 0x00000000040,     // TITLE is profession trainer DESCRIPTION 100%
    UNIT_NPC_FLAG_VENDOR                    = 0x00000000080,     // TITLE is vendor (generic) DESCRIPTION 100%
    UNIT_NPC_FLAG_VENDOR_AMMO               = 0x00000000100,     // TITLE is vendor (ammo) DESCRIPTION 100%, general goods vendor
    UNIT_NPC_FLAG_VENDOR_FOOD               = 0x00000000200,     // TITLE is vendor (food) DESCRIPTION 100%
    UNIT_NPC_FLAG_VENDOR_POISON             = 0x00000000400,     // TITLE is vendor (poison) DESCRIPTION guessed
    UNIT_NPC_FLAG_VENDOR_REAGENT            = 0x00000000800,     // TITLE is vendor (reagents) DESCRIPTION 100%
    UNIT_NPC_FLAG_REPAIR                    = 0x00000001000,     // TITLE can repair DESCRIPTION 100%
    UNIT_NPC_FLAG_FLIGHTMASTER              = 0x00000002000,     // TITLE is flight master DESCRIPTION 100%
    UNIT_NPC_FLAG_SPIRITHEALER              = 0x00000004000,     // TITLE is spirit healer DESCRIPTION guessed
    UNIT_NPC_FLAG_SPIRITGUIDE               = 0x00000008000,     // TITLE is spirit guide DESCRIPTION guessed
    UNIT_NPC_FLAG_INNKEEPER                 = 0x00000010000,     // TITLE is innkeeper
    UNIT_NPC_FLAG_BANKER                    = 0x00000020000,     // TITLE is banker DESCRIPTION 100%
    UNIT_NPC_FLAG_PETITIONER                = 0x00000040000,     // TITLE handles guild/arena petitions DESCRIPTION 100% 0xC0000 = guild petitions, 0x40000 = arena team petitions
    UNIT_NPC_FLAG_TABARDDESIGNER            = 0x00000080000,     // TITLE is guild tabard designer DESCRIPTION 100%
    UNIT_NPC_FLAG_BATTLEMASTER              = 0x00000100000,     // TITLE is battlemaster DESCRIPTION 100%
    UNIT_NPC_FLAG_AUCTIONEER                = 0x00000200000,     // TITLE is auctioneer DESCRIPTION 100%
    UNIT_NPC_FLAG_STABLEMASTER              = 0x00000400000,     // TITLE is stable master DESCRIPTION 100%
    UNIT_NPC_FLAG_GUILD_BANKER              = 0x00000800000,     // TITLE is guild banker DESCRIPTION
    UNIT_NPC_FLAG_SPELLCLICK                = 0x00001000000,     // TITLE has spell click enabled
    UNIT_NPC_FLAG_PLAYER_VEHICLE            = 0x00002000000,     // TITLE is player vehicle DESCRIPTION players with mounts that have vehicle data should have it set
    UNIT_NPC_FLAG_MAILBOX                   = 0x00004000000,     // TITLE is mailbox
    UNIT_NPC_FLAG_ARTIFACT_POWER_RESPEC     = 0x00008000000,     // TITLE can reset artifact powers
    UNIT_NPC_FLAG_TRANSMOGRIFIER            = 0x00010000000,     // TITLE transmogrification
    UNIT_NPC_FLAG_VAULTKEEPER               = 0x00020000000,     // TITLE is void storage
    UNIT_NPC_FLAG_WILD_BATTLE_PET           = 0x00040000000,     // TITLE is wild battle pet DESCRIPTION Pet that player can fight (Battle Pet)
    UNIT_NPC_FLAG_BLACK_MARKET              = 0x00080000000,     // TITLE is black market
    UNIT_NPC_FLAG_ITEM_UPGRADE_MASTER       = 0x00100000000,     // TITLE is item upgrade
    UNIT_NPC_FLAG_GARRISON_ARCHITECT        = 0x00200000000,     // TITLE is garrison architect DESCRIPTION garrison building placement UI
    UNIT_NPC_FLAG_STEERING                  = 0x00400000000,     // TITLE is avoiding obstacles DESCRIPTION clientside pathfinding
    UNIT_NPC_FLAG_SHIPMENT_CRAFTER          = 0x01000000000,     // TITLE is shipment crafter DESCRIPTION garrison work orders
    UNIT_NPC_FLAG_GARRISON_MISSION_NPC      = 0x02000000000,     // TITLE is garrison mission
    UNIT_NPC_FLAG_TRADESKILL_NPC            = 0x04000000000,     // TITLE is tradeskill DESCRIPTION crafting at npc

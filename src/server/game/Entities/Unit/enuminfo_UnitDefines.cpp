...
template <>
TC_API_EXPORT size_t EnumUtils<NPCFlags2>::Count() { return 11; }
...
TC_API_EXPORT NPCFlags2 EnumUtils<NPCFlags2>::FromIndex(size_t index)
{
    switch (index)
    {
        ...
        case 10: return UNIT_NPC_FLAG_2_SUPPRESS_NPC_SOUNDS_EXCEPT_END_OF_INTERACTION;
        default: throw std::out_of_range("index");
    }
}
...
TC_API_EXPORT size_t EnumUtils<NPCFlags2>::ToIndex(NPCFlags2 value)
{
    switch (value)
    {
        ...
        case UNIT_NPC_FLAG_2_SUPPRESS_NPC_SOUNDS_EXCEPT_END_OF_INTERACTION: return 10;
        default: throw std::out_of_range("value");
    }
}
}
